...
```
Read output/md/Thesis_Formatting_Approved_Changes.md. Apply ONLY the changes listed there, exactly as specified. Do not apply any change not in the approved list. After each edit, verify the file still compiles. Output a summary of applied changes to output/md/Thesis_Formatting_Applied_Summary.md.
```
