...
Several deliberate scope constraints are imposed. The thesis does not attempt to forecast token prices or market capitalization, following critiques of predictive overreach in crypto-asset valuation literature \cite{CFA2018}. It does not claim causal certainty regarding real-world network behavior. Nor does it propose novel tokenomic designs; instead, existing mechanisms are evaluated through controlled experimentation.
...
This thesis makes three contributions: a structured simulation approach for stress-testing DePIN tokenomics under adverse conditions, drawing on established evaluation frameworks for complex systems modeling \cite{Sollaci2004, Morris2019}; the application of this framework to a real-world DePIN case, translating conceptual incentive mechanisms into testable model parameters; and an emphasis on comparative robustness and trade-off analysis over prediction, offering a practical evaluation tool for both researchers and protocol designers.
...
% TODO-CITE: [Buterin 2014; Arthur 1989] DeFi contrast and path dependence

A minimal DePIN economic structure includes four interacting actors: infrastructure providers, end users, the protocol rule layer, and the token layer. Providers deploy and maintain hardware, users consume services, the protocol verifies work and allocates rewards, and the token system links service contribution to compensation and governance.
% TODO-CITE: [Rochet and Tirole 2003; Catalini and Gans 2016; Cong et al. 2021] actor structure
...
% TODO-CITE: [Arthur 1989; Teunissen and Montenbruck 2017] sunk costs and recovery hysteresis
...
% TODO-CITE: [DePIN hardware economics evidence] stickiness vs liquidity contrast
...
\subsection{Person A Draft Import (Provisional, Source-Preserving)}
\label{subsec:personA_foundations_import}
